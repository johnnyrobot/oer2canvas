...
- Pasted and file-selected text, Markdown, and HTML are decoded as strict UTF-8 and limited to
  ...
  the same final allowlist and accessibility gate as publisher content. Relative image references
  without a public source URL are reported as unavailable and block preparation. Source files and
  derived document data remain browser-local.
