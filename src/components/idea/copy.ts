...
export const IDEA_COPY = {
  ...
  llm: {
    ...
    plan: {
      heading: 'Plan the revisions',
      intro: 'OERI’s Step 5: turn this review into a restorative revision plan — instructor-facing notes, and student-facing framing where a passage needs context rather than replacement.',
      nothing: 'Rate, note, accept, or draft something first — the plan is built from your review.',
      sends: 'What leaves your browser when you press the button: this chapter’s ratings and notes, the edits you applied, and this session’s undecided drafts. Not the chapter’s text.',
      send: (provider: string) => `Draft a revision plan with ${provider}`,
      table: 'Revision plan',
      priority: 'Priority',
      where: 'Where',
      issue: 'Issue',
      revision: 'Revision',
      rationale: 'Rationale',
      licence: 'Licence allows',
      student: 'Student-facing drafts',
      purpose: 'Purpose',
      copy: 'Copy',
      copied: 'Copied.',
