...
import { TEXT_CONTENT_FILE_ACCEPT } from '../import/capability'
...
/**
 * The paste-or-file form for text, Markdown, and HTML. It parses locally and
 * hands the normalized result to its owner; the proposed page plan, findings,
 * and preview are the `ImportPlanEditor`'s, so that editing them never comes
 * back through this form and never reparses the source.
 */
export function TextContentImporter({ onImported }: { onImported: (result: ImportResult) => void }) {
